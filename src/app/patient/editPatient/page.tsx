...
// 	const EditPatient: React.FC<{ patientId: string }> = ({ patientId }) => {

// 		const [patient, setPatient] = useState<Patient | null>(null);
// 		const [loading, setLoading] = useState<boolean>(true);
// 		const [error, setError] = useState<string | null>(null);
// 		const [updatedData, setUpdatedData] = useState<Partial<Patient>>({});
...
// 			try {
// 			  const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/patients/${patientId}`, {
// 				method: "POST",
// 				headers: {
